...
// SHIPPY PATCH: accessors for the --files-from list path and NUL delimiting.
func (o *Options) FilesFrom() string { return o.files_from }
func (o *Options) EolNulls() bool    { return o.eol_nulls != 0 }
...
func (o *Options) gokrazyTable() []poptOption {
	...
	return []poptOption{
		...
		// SHIPPY PATCH: enable --files-from/--from0 on the client-sender so an
		// explicit file list can drive the transfer. See SHIPPY_PATCHES.md.
