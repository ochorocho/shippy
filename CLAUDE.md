...
Shippy is a minimal, opinionated deployment tool for TYPO3 projects written in pure Go. It provides zero-downtime deployments with atomic releases via SSH, inspired by Deployer and Capistrano. Single binary, no external dependencies.
